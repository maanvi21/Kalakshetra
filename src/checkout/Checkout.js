...
const Checkout = () => {
  ...
  // ✅ Wrapped in useCallback so it can be a stable dependency
  ...
  const handleBillingAddressTypeChange = (type) => setBillingAddressType(type);
  ...
  const validateForm = () => {
    ...
    if (!emailPattern.test(formData.email)) newErrors.email = 'Please enter a valid email or phone number';
    ...
    if (!pincodePattern.test(formData.pincode)) newErrors.pincode = 'Please enter a valid 6-digit PIN code';
    if (!phonePattern.test(formData.phone)) newErrors.phone = 'Please enter a valid phone number';

    if (billingAddressType === 'different') {
      if (billingAddress.firstName.trim() === '') newErrors.billingFirstName = 'Please enter your first name';
      if (billingAddress.lastName.trim() === '') newErrors.billingLastName = 'Please enter your last name';
      if (billingAddress.address.trim() === '') newErrors.billingAddress = 'Please enter your address';
      if (billingAddress.city.trim() === '') newErrors.billingCity = 'Please enter your city';
      if (billingAddress.state === '') newErrors.billingState = 'Please select your state';
      if (!pincodePattern.test(billingAddress.pincode)) newErrors.billingPincode = 'Please enter a valid 6-digit PIN code';
    }
        ...
        <div className="container">
          ...
          <div className="checkout-form">
            ...
            <div className="checkout-buttons">
              <Button text="Back to Cart" onClick={() => navigate('/cart')} />
              <Button
